<script>
  ...
  $: statusMeta = {
    ...
    progressing: { label: $t('fs.status.progressing'), cls: 'badge-outline' },
    resolved:    { label: $t('fs.status.resolved'),    cls: 'badge-ghost' },
  ...
  <div class="card bg-base-200 border border-base-300">
    <div class="card-body py-4 gap-3">
      ...
      <div class="flex flex-wrap gap-2 text-sm">
        ...
        <span class="badge badge-ghost">{$t('fs.stats.resolved', { n: resolvedCount })}</span>
